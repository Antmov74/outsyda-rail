          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-8">
              ...
              <p className="text-white/70">
                Begin or end beside one of Switzerland&apos;s most beautiful
                lakes, with Montreux offering a refined Riviera atmosphere.
              </p>
            </div>
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-8">
              <h3 className="mb-4 text-2xl font-light">Flexible Itineraries</h3>
              <p className="text-white/70">
                Combine the route with Lucerne, Zermatt, Interlaken, Jungfrau
                experiences or luxury lake and mountain hotels.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-12 max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-relaxed text-white/70">
              Follow the spectacular journey from Montreux on Lake Geneva through
              Gstaad, Zweisimmen and Spiez before arriving in Interlaken, linking
              vineyards, alpine valleys and some of Switzerland's most iconic scenery.
            </p>
          </div>
      ...
      <section className="bg-[#0a0a0a] px-6 py-24">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto mb-10 max-w-3xl text-lg leading-relaxed text-white/70">
            Speak with Outsyda Rail about GoldenPass Express journeys, Swiss
            rail passes, luxury hotels and tailor-made alpine extensions.
          </p>
