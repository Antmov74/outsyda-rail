...
export default function GlacierExpressPage() {
  const itinerary = [
    {
      day: "Day 1",
      title: "Arrive in Zermatt",
      description:
        "Travel by rail to car-free Zermatt and settle into your chosen hotel beneath the Matterhorn. Spend the evening exploring the village at your own pace.",
    },
    {
      day: "Day 2",
      title: "Explore Zermatt",
      description:
        "Enjoy a full day in Zermatt, with options including the Gornergrat Railway, Matterhorn Glacier Paradise, guided walking or time relaxing in the village.",
    },
    {
      day: "Day 3",
      title: "Glacier Express to St Moritz",
      description:
        "Board the Glacier Express for the spectacular full-day journey through the Swiss Alps. Cross the Oberalp Pass, Rhine Gorge, 291 bridges and 91 tunnels before arriving in St Moritz.",
    },
    {
      day: "Day 4",
      title: "Discover St Moritz",
      description:
        "Spend the day exploring St Moritz and the Engadin Valley. Optional experiences include mountain railways, lakeside walks, spa time or an additional scenic rail journey.",
    },
    {
      day: "Day 5",
      title: "Depart or Extend",
      description:
        "Continue by rail to Zurich, Milan or another Swiss destination, or extend your holiday with the Bernina Express, Lake Como or additional time in the Alps.",
    },
  ];
    ...
    <main className="bg-black text-white">
      ...
      <section className="relative min-h-screen overflow-hidden">
        <img
          ...
          alt="Glacier Express travelling through the Swiss Alps"
          ...
          <div className="max-w-3xl">
            ...
            <div className="mt-8 rounded-2xl border border-white/10 bg-black/40 p-6">
              ...
              <p className="mt-2 text-sm uppercase tracking-[0.2em] text-white/55">
                Zermatt • Glacier Express • St Moritz
              </p>
            </div>
      ...
      <section className="bg-[#0a0a0a] px-6 py-24">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="max-w-4xl text-lg leading-relaxed text-white/70">
            ...
            Moritz. Panoramic carriages provide uninterrupted views of
            mountains, valleys, forests and traditional alpine villages.
          </p>

          <p className="mt-6 max-w-4xl text-lg leading-relaxed text-white/70">
            This five-day tailor-made itinerary adds time in both mountain
            resorts, turning the famous train journey into a properly paced
            Swiss holiday.
          </p>
        </div>
      </section>
      ...
      <section className="bg-black px-6 py-24">
        <div className="mx-auto max-w-7xl">
          ...
          <h2 className="mb-12 text-4xl font-light md:text-5xl">
            Your Glacier Express journey, day by day
          </h2>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-12 max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-relaxed text-white/70">
              ...
              Chur and St Moritz, crossing some of Switzerland&apos;s most
          ...
          <div className="overflow-hidden rounded-3xl border border-white/15 bg-white p-4 shadow-2xl">
            <img
              ...
              alt="Map showing the Glacier Express route from Zermatt to St Moritz"
      ...
      <section id="enquire" className="bg-[#0a0a0a] px-6 py-24">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto mb-10 max-w-3xl text-lg leading-relaxed text-white/70">
            ...
            options, upgrades and tailor-made extensions across Switzerland.
          </p>

          <a
            href="mailto:ant@outsyda.com?subject=Glacier%20Express%20Enquiry"
